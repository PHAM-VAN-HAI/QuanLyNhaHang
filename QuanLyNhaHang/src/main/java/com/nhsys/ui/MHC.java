 ...
 * @author VU
 */
public class MHC extends javax.swing.JFrame {

    /**
     * Creates new form MHC
     */
    public MHC(boolean isManager) {
        initComponents();
        if (isManager) {
            reloadPanelMenu(1);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MHC.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
